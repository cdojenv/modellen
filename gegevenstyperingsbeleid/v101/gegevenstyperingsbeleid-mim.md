...
|Mogelijke waarden|Classificatie BIV Vertrouwelijkheid; Classificatie AKI-gegevens; Classificatie Gerechtelijke Strafgegevens; Classificatie Justitiële Gegevens; Classificatie Basisbeveiligingsniveau (BBN); Classificatie Politiegegevens; Classificatie Rubriceringsniveau; Classificatie Vitaal Belang; Classificatie Persoonsgegevens; Classificatie BIV Integriteit; Classificatie Verantwoordingsbelang; Classificatie Tenuitvoerleggingsgegevens; Classificatie BIV Beschikbaarheid; Classificatie Continuïteitsbelang; Classificatie Strafvorderlijke Gegevens|
...
|Mogelijke waarden|gegevensmanager; gegevenskwaliteitscontroleur; gegevensverantwoordelijke; data steward; gegevensmodelleur|
...
|{: .def}||
|-|-|
|Rol van|0..* 0..1 [Domeinrelatieverbintenis](#TDomeinrelatieverbintenis)|
...
|Rol van|0..* [Attribuuttype](#TAttribuuttype)|
|Met|0..1 [Waardetype](#TWaardetype)|
...
|Rol van|0..* [Begrip](#TBegrip)|
|Met|0..1 [Juridische classificatie](#TJuridische-classificatie)|
...
|Rol van|0..* [Classificatie](#TClassificatie)|
|Met|0..1 [Classificatietype](#TClassificatietype)|
...
|Rol van|0..* [Normatieve betekenis van Gegevenstype (U3)](#TNormatieve-betekenis-van-Gegevenstype-U3)|
|Met|0..1 [Gegevensmodelleur](#TGegevensmodelleur)|
...
|Rol van|0..* [Gegevensobjecttype met domeinobjecttype als hoofdonderwerp](#TGegevensobjecttype-met-domeinobjecttype-als-hoofdonderwerp)|
|Met|0..1 [Domeinobjecttype](#TDomeinobjecttype)|
...
|Rol van|0..* [Gegevensobjecttype met domeinrelatietype als hoofdonderwerp](#TGegevensobjecttype-met-domeinrelatietype-als-hoofdonderwerp)|
|Met|0..1 [Domeinrelatietype](#TDomeinrelatietype)|
...
|Rol van|0..1 [Gegevensobjecttype](#TGegevensobjecttype)|
...
|Rol van|0..* [Gegevensset](#TGegevensset)|
|Met|0..1 [Gegevensopslag](#TGegevensopslag)|
...
|Rol van|0..* [Gegevenssetspecificatie](#TGegevenssetspecificatie)|
|Met|0..1 [Logisch gegevensmodel](#TLogisch-gegevensmodel)|
...
|Rol van|0..1 [Gegevenstype](#TGegevenstype)|
|Met|0..* [ElementairGegeven](#TElementairGegeven)|
...
|Rol van|0..* [Gegevensset](#TGegevensset)|
|Met|0..1 [Gegevensverantwoordelijke](#TGegevensverantwoordelijke)|
...
|Rol van|0..1 [Relatiedomeinobjecttype](#TRelatiedomeinobjecttype)|
|Met|0..* [Relatiedomeinobject](#TRelatiedomeinobject)|
...
|Rol van|0..1 [Domeinrelatieverbintenis](#TDomeinrelatieverbintenis)|
|Met|0..* [Relatiegegevenstype](#TRelatiegegevenstype)|
...
|Rol van|0..* [Relatiegegevenstype](#TRelatiegegevenstype)|
|Met|0..1 [Gegevensobjecttype met domeinobjecttype als hoofdonderwerp](#TGegevensobjecttype-met-domeinobjecttype-als-hoofdonderwerp)|
...
|Rol van|0..1 [Verwerkingsdomein](#TVerwerkingsdomein)|
...
|Rol van|0..* [Waardegegevenstype](#TWaardegegevenstype)|
|Met|0..1 [Attribuuttype](#TAttribuuttype)|
...
|Rol van|0..1 0..* [Kennisbron](#TKennisbron)|
|Met|0..1 0..* [Kennisbron](#TKennisbron)|
