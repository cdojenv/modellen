...
1. Het [conceptueel informatiemodel (CIM) van het gegevenstyperingsbeleid](#cim-gegevenstyperingsbeleid) (CIM). Dit model beschrijft de informatiebehoefte in termen van de relevante objecten en hun eigenschappen. **Let op:** de grijze elementen in het model zijn bedoeld om het verhaal te ondersteunen en begrijpelijker te maken, maar geen onderdeel van de te voeren administratie;
...
**LET OP**: De gemaakte modellen vormen een informatiemodel en moeten niet worden gebruikt als logische gegevensmodellen waarop rechtstreeks een administratie kan worden gebouwd. Er is nog een bepaalde mate van interpretatie nodig voordat dit mogelijk is.
