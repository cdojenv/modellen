...
Gerelateerd: [GLP afspraak](#glp-afspraak), [Gegevensdeling](#gegevensdeling)
...
Gerelateerd: [Gegevensdeling](#gegevensdeling), [Gegevensleveringsprotocol](#gegevensleveringsprotocol), [GLP afspraak](#glp-afspraak)
...
Toelichting: Een GLP afspraak is een afspraak die van toepassing is op de juridische en organisatorische aspecten van de gegevensdeling. 
...
> Een [afspraak](#afspraak) over de interpretatie van het gegevensmiddel is een [gegevensmiddelafspraak](#gegevensmiddelafspraak) over de manier waarop bepaalde zaken in een gegevensmiddel moeten worden geïnterpreteerd.
...
> Een [afspraak](#afspraak) over foutherstel door hernieuwde levering is een [GLS afspraak](#gls-afspraak) die beschrijft hoe wordt omgegaan met opnieuw aangeleverde gegevens, bijvoorbeeld na het optreden van fouten in de oorspronkelijke [gegevensdeling](#gegevensdeling).
...
> Bevat [politiegegevens](#politiegegevens) over verdachte personen.
...
### Betrokkenen bij strafvorderlijke gegevens: veroordeelde dader(s)
...
Bron: DUTO-proces Vernietigen [[NA-vernietigen]]
...
> Een verzameling GLS Standaardafspraken is een voorgedefinieerde verzameling [afspraken](#afspraak) die kan worden gebruikt bij het opstellen van een [gegevensleveringsspecificatie](#gegevensleveringsspecificatie) (GLS).
...
Toelichting: Het is mogelijk, maar niet verplicht, dat per gegevensleverset andere gegevens worden geleverd en dat daar ook andere afspraken over worden gemaakt. 
...
Voorbeeld(en): Een gegevensleverset met gevoelige gegevens en een gegevensleverset zonder gevoelige gegevens hebben vaak andere afspraken over toegangsgerechtigden en beveiliging.
...
Voorbeeld(en): Het gegevenstype “Persoon” kan in één gegevensleverset bestaan uit alle personen die wonen in Amsterdam, en in een andere uit alle personen die wonen in Utrecht.

### Gegevensleversetspecificatie

Alternatieve aanduiding: *GLSS*
...
Gerelateerd: [Afspraak](#afspraak), [Gegevensdelingsbeleid](#gegevensdelingsbeleid), [Gegevensdelingsbeleid](#gegevensdelingsbeleid), [Gegevensdeling](#gegevensdeling), [Gegevensleverset](#gegevensleverset)
...
Toelichting: Het is mogelijk, maar niet verplicht, dat per gegevensmiddel andere afspraken worden gemaakt voor bepaalde zaken. De volgende afspraakonderwerpen zijn specifiek voor gegevensmiddelen:
...
Gerelateerd: [Gegevensmiddel](#gegevensmiddel), [Ontvanger](#ontvanger), [Verstrekker](#verstrekker), [Afspraak](#afspraak), [Gegevensdeling](#gegevensdeling)

Voorbeeld(en): Het kan zijn dat een gegevensleverset in meerdere gegevensmiddelen wordt geleverd, met specifieke formaten. Of dat een bepaald gegevensmiddel via een andere route naar de ontvanger gaat en daardoor andere eisen kent.
...
*Gegevenstype wordt opnieuw gedefineerd in het gegevenstyperingsbeleid. Die definitie zal hier worden overgenomen wanneer deze definitief is geworden.*
...
Gerelateerd: [Gegevensmiddel](#gegevensmiddel), [Gegevenstype](#gegevenstype), [Gegevensleverset](#gegevensleverset), [Gegevensveld](#gegevensveld)
...
Gerelateerd: [Gegevensmiddel](#gegevensmiddel), [Technisch gegevensmodel](#technisch-gegevensmodel), [Gegevenstype](#gegevenstype), [Logisch gegevensmodel](#logisch-gegevensmodel)

Voorbeeld(en): Een veld “bedrag” met corresponderend attribuut Bedrag In Euro’s in een logisch gegevensmodel kan een veldtype tekst hebben, i.v.m. de beperkingen van de technische interface. Uiteindelijk wordt na conversie de inhoud van het technisch gegevensveld wel weer getoetst aan het logisch gegevensmodel.

### Gerechtelijke Strafgegevens

> Gerechtelijke strafgegevens zijn [persoonsgegevens](#persoonsgegeven) of gegevens over een rechtspersoon die zijn verkregen in het kader van het behandelen en beslissen van zaken waarop het Nederlandse strafrecht van toepassing is en die in een [politiegegevensbestand](#politiegegevensbestand) zijn of worden verwerkt.

Bron: Artikel 1e, [[WSJG2024]]

Gerelateerd: [Persoonsgegeven](#persoonsgegeven), [Politiegegevensbestand](#politiegegevensbestand)
...
> Justitiële gegevens zijn bij algemene maatregel van bestuur omschreven [persoonsgegevens](#persoonsgegeven) of gegevens over een rechtspersoon inzake de toepassing van het strafrecht of de strafvordering, die in een [politiegegevensbestand](#politiegegevensbestand) zijn of worden verwerkt.

Bron: Artikel 1a, [[WSJG2024]]

Gerelateerd: [Politiegegevensbestand](#politiegegevensbestand), [Persoonsgegeven](#persoonsgegeven)
...
> Een kwaliteitseis is een eis aan een bepaald kwalitatief aspect van de [gegevensdeling](#gegevensdeling), waar dat aspect bij meting aan moet voldoen.

Toelichting: Deze conditie omschrijft de kwaliteitsdimensie waarop wordt gemeten, de kwaliteitsmeetwaarde die wordt gemeten, en de normering waarop deze wordt getoetst. Dit wordt omschreven in natuurlijke taal. Meer informatie is te vinden in het gegevenskwaliteitsbeleid.

Bron: Kerndepartement J&V [[KDJV]], JAGA Gegevenskwaliteitsbeleid v1.0 [[Gegevenskwaliteitsbeleid]]

Gerelateerd: [Gegevensdeling](#gegevensdeling)

Voorbeeld(en): Afspraken over het conformeren van de levering aan de afgesproken gegevenstypering, de juiste vorm van het gegevensmiddel, de tijdigheid, actualiteit en volledigheid van de geleverde gegevens.
...
Gerelateerd: [Functionaris](#functionaris), [Verstrekker](#verstrekker), [Gegevensdeling](#gegevensdeling)
...
Gerelateerd: [Ontvanger](#ontvanger), [Gegevensdeling](#gegevensdeling), [Functionaris](#functionaris)

### Persoonsgegevens Aanwezig: bevat geen persoonsgegevens

> Bevat geen informatie die herleidbaar is tot natuurlijke personen.

Bron: Verordening (EU) 2016/679 [[AVG]]

### Persoonsgegevens Aanwezig: bevat persoonsgegevens

> Bevat informatie die herleidbaar is tot natuurlijke personen.
...
Gerelateerd: [Gegevensclassificatie](#gegevensclassificatie), [Gegevenstype](#gegevenstype), [Gegevensdeling](#gegevensdeling), [Gegevensleverset](#gegevensleverset)

### Politiegegevens

> Een politiegegeven is elk persoonsgegeven dat wordt verwerkt in het kader van de uitvoering van de politietaak, bedoeld in de artikelen 3 en 4 van de Politiewet 2012, met uitzondering van:
...
### Politiegegevens: bevat gewone politiegegevens
...
Gerelateerd: [Gegevensclassificatie](#gegevensclassificatie), [Gegevensdeling](#gegevensdeling), [Gegevensleverset](#gegevensleverset), [Gegevenstype](#gegevenstype)

### Populatiebeschrijving

> Een populatiebeschrijving is een globale en informele beschrijving van de inhoud van de [gegevensdeling](#gegevensdeling) of van een specifieke [gegevensleverset](#gegevensleverset) binnen die gegevensdeling, waarbij zowel de relevante [gegevenstypen](#gegevenstype) als de inhoud van die gegevenstypen globaal wordt beschreven in verhalende vorm. Indien van toepassing beschrijft men hier ook welke [gegevensfilterregels]() zijn toegepast om deze populatie te selecteren uit een bredere populatie.

Toelichting: Deze beschrijving vertelt o.a. hoe deze populatie is samengesteld (uit een potentieel bredere gegevensset van de bron). Het is daarbij niet de bedoeling de achtergrond van de levering te bespreken, dat gebeurt elders. Het gaat hier alleen om het begrijpelijke en leesbare verhaal, niet om een formele specificatie.

Bron: Kerndepartement J&V [[KDJV]]

Gerelateerd: [Gegevensdeling](#gegevensdeling), [Gegevenstype](#gegevenstype), [Gegevensleverset](#gegevensleverset), [gegevensfilterregels](#gegevensfilterregels)
...
### Type Bijzondere Persoonsgegevens: gegevens over iemands seksueel gedrag of seksuele gerichtheid
...
### Type Bijzondere Persoonsgegevens: gegevens over lidmaatschap van een vakbond

> Bevat tot natuurlijke personen herleidbare informatie over het lidmaatschap van een vakbond.

Bron: Wat zijn persoonsgegevens (Autoriteit Persoonsgegevens) [[APG-persoonsgegevens]], Kerndepartement J&V [[KDJV]]

### Type Bijzondere Persoonsgegevens: gegevens over politieke opvattingen

> Bevat tot natuurlijke personen herleidbare informatie over politieke opvattingen.

Bron: Wat zijn persoonsgegevens (Autoriteit Persoonsgegevens) [[APG-persoonsgegevens]], Kerndepartement J&V [[KDJV]]

### Type Bijzondere Persoonsgegevens: gegevens over ras of etnische afkomst

> Bevat tot natuurlijke personen herleidbare informatie over etniciteit en afkomst.

Bron: Wat zijn persoonsgegevens (Autoriteit Persoonsgegevens) [[APG-persoonsgegevens]], Kerndepartement J&V [[KDJV]]

### Type Bijzondere Persoonsgegevens: gegevens over religieuze of levensbeschouwelijke overtuigingen
...
### Type Persoonsgegevens: bevat bijzondere persoonsgegevens
...
### Type Persoonsgegevens: bevat gevoelige persoonsgegevens
...
### Type Persoonsgegevens: bevat gewone persoonsgegevens

> Bevat tot natuurlijke personen herleidbare informatie.

Bron: Verordening (EU) 2016/679 [[AVG]]

### Type Persoonsgegevens: bevat nationale identificatienummers

> Bevat nummers die ter identificatie van een persoon bij wet zijn voorgeschreven.

Toelichting: Een voorbeeld van een nationaal identificatienummer is het Burger Service Nummer (BSN).

Bron: Verordening (EU) 2016/679 [[AVG]]

### Type Persoonsgegevens: bevat strafrechtelijke persoonsgegevens
...
Toelichting: Het gaat hier om strafrechtelijke gegevens die ook persoonsgegevens zijn.

Bron: Verordening (EU) 2016/679 [[AVG]]

### Type persoonsgegeven

> Een type persoonsgegeven is een aanduiding van de inhoud van een [persoonsgegeven](#persoonsgegeven), onafhankelijk van de context van het gebruik daarvan.

Toelichting: De mogelijke typen persoonsgegevens zijn:

* gewoon persoonsgegeven,
* gevoelig persoonsgegeven,
* bijzonder persoonsgegeven,
* strafrechtelijk persoonsgegeven, en 
*nationaal identificatienummer. 

Deze worden aangeduid met 'gewoon', 'gevoelig', et cetera.

*Deze definitie is afgeleid van het gebruik in het Model DPIA Rijksdienst.*

Bron: paragraaf 3.2, pagina 26, paragraaf 3.2, pagina 26, Model [[ModelDPIARijksdienst]] [[DPIA]]

Gerelateerd: [Persoonsgegeven](#persoonsgegeven)

### Verantwoordingsbelang

> Een verantwoordingsbelang is een duiding van de vereiste duur en vorm van duurzame toegankelijkheid en uiteindelijke vernietiging van gegevens, ten behoeve van het kunnen afleggen van verantwoording.

Toelichting: Een verantwoordingsbelang is een classificatie van classificatiecategorie verwerkingsbelang, dat aangeeft of een partij belang heeft bij de inhoud van een gegevenstype of gegevensleverset om de overheid verantwoording te kunnen laten afleggen over haar handelen (en besluiten), of juist bij het beëindigen van die mogelijkheid. Hieruit volgt (op basis van de selectielijst) hoe lang de informatie moet worden bewaard en wanneer deze (eventueel) moet worden vernietigd.
...
Voorbeeld(en): De discussie over de publicatie van het Centraal Archief Bijzondere Rechtspleging door het Nationaal Archief in 2024/2025 is een voorbeeld van de botsende belangen bij archivering: verantwoording en het verkrijgen van historisch inzicht in de procesgang rond oorlogsmisdaden versus de privacy van betrokkenen.
...
### Verantwoordingsbelang: ja, de termijn is afhankelijk van de context
...
Toelichting: Bij deze classificatie dient altijd ook een context te worden aangegeven.

Bron: Kerndepartement J&V [[KDJV]]

Voorbeeld(en): "Vernietigen 125 jaar na overlijden betrokkene" is een vernietigingstermijn die niet al bij het ontstaan van de informatie kan worden vastgesteld.

### Verantwoordingsbelang: ja, moet blijvend worden bewaard

> Voor deze informatie is geen vernietigingsdatum voorzien.

Toelichting: Het kan zijn dat de informatie op enig moment moet worden overgedragen aan het Nationaal Archief.

Bron: Kerndepartement J&V [[KDJV]]

### Verantwoordingsbelang: ja, moet tijdelijk worden bewaard

> Voor deze informatie is de vernietigingsdatum bekend. De informatie wordt vernietigd op of na de vernietigingsdatum.

Toelichting: Zie voor meer informatie over het vernietigingsproces ook de website van het Nationaal Archief.

Bron: Kerndepartement J&V [[KDJV]]

Voorbeeld(en): "Vernietigen na 7 jaar" is een context-afhankelijke vernietigingstermijn die kan worden vastgesteld bij het ontstaan van de informatie.
...
Gerelateerd: [Risicoclassificatie](#risicoclassificatie), [Partij](#partij)
...
> Zonder deze gegevens is er gevaar voor het leven van de betrokkene of een ander natuurlijk persoon.

Bron: Kerndepartement J&V [[KDJV]]

### Waardebereik gegevenstype

> Een waardebereik beschrijft welke waarden een [categorisch gegevenstype](#categorisch-gegevenstype) kan hebben.
...
Gerelateerd: [Categorisch gegevenstype](#categorisch-gegevenstype)

Voorbeeld(en): Het gaat hier om enumeraties als "enkel; dubbel; drievoudig" etc.
...
Voorbeeld(en): Blob, Boolean, Byte, Categorical, Date, Decimal, Double, String, etc.
